...
import lang.ui.oo.common.LugarParaTipoDeRetornoDeConsultas;

public class ConsultaEncabezado extends Bloque {
    ...
    public function getVariablesLocales(): Variable[] {
        ...
        // pongo entre las variables locales a la variable result de devolucion del metodo...
        if (_lugarTipoRetorno.tipoEspecificado) {
            insert Variable {
                nombre: _lugarTipoRetorno.nombre
                tipo: _lugarTipoRetorno.tipo
            } into res;
        }
        return res;
    }
    ...
    def _nombre = NombreDefinicionRutina {
                tipoRutina: "Consulta"
                nombreDefinido: bind consultaCreada
            }
    ...
    def _lugarTipoRetorno = bind LugarParaTipoDeRetornoDeConsultas {
            }
    var vb = VBox {
                content: [
                    _nombre,
    ...
    public override var huecos: Hueco[] = bind [_entrada.huecos, _pre.huecos,
                _pos.huecos, _varLocales.huecos, _lugarTipoRetorno.huecos] on replace { }
